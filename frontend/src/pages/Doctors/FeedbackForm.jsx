    ...
    return (
        <form action="">
            ...
            <h3 className="text-headingColor text-[16px] leading-6 font-semibold mb-4">
                ...
                <textarea name="" id="" className='border border-solid border-[#00664434] focus:outline outline-primaryColor w-full px-4 py-3 rounded-md' placeholder='Write your message' rows="5" onChange={()=>setReviewText(e.target.value)}></textarea>
            </div>
