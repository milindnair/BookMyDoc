...
const DoctorAbout = () => {
    return (
        <div>
            :pin
            <div>
                <h3 className='text-[20px] leading-[30px] text-headingColor font-semibold flex items-center gap-2'>About of <span className='text-irisBlueColor font-bold text-[24px] leading-9 '>Karthikeya Mishra</span></h3>
                <p className="text__para">Lorem ipsum dolor sit amet consectetur adipisicing elit. Illum, reiciendis. Voluptas sequi eveniet quidem accusantium voluptatibus quae vero distinctio. Illo ullam nobis atque exercitationem aut alias laborum consequuntur eius natus.</p>
            </div>
            <div className='mt-12'>
